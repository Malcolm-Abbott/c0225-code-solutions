...
const $mainRowImage = document.querySelector('.main-row-image');
const $mainRow = document.querySelector('.main-row');
const $iconRowChildren = $iconRow.children;
const arrayOfIconRowChildren = [...$iconRowChildren];
let currentIndex = 0;
...
function handleIconRowClick(event) {
  clearAndSetInterval();
...
function setSourceToCarouselImage(index, img) {
  switch (index) {
    case 0:
...
function setIconClass(arrayOfIcons) {
